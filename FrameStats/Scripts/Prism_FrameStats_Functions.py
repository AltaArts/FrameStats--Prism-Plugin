...
class Prism_FrameStats_Functions(object):
    ...
    def mediaPlayerContextMenuRequested(self, origin, menu):        #   Adds OpenWithMenu to Media Image Right-Click-Menu
        ...
        #   This helps when a media file is actively playing in the Viewer
        try:
        ...
        frameStatsAct = QAction("Frame Stats...", menu)
        frameStatsAct.triggered.connect(lambda: self.launchFrameStats(filePath))
        menu.addAction(frameStatsAct)
